...
describe("menu.html", () => {
  ...
  it("üst menüde 3 adet sosyal medya iconu doğru konumlandırılmış", () => {
    const headerNavLinks = container.querySelector("header div");
  ...
  it("5 adet menu-section class'ı doğru başlıklarla tespit edildi", () => {
    const menuSections = Array.from(container.querySelectorAll(".menu-item"));
    expect(menuSections.length).toBe(17);
    ...
    for (let i = 0; i < menuSections.length; i++) {
      ...
      } else `Beklenmeyen menü sectionı`;
    }
  });
